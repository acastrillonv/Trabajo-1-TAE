...
prueba <- data_modelo[10,]
prediccion <- as.data.frame(predict(agrupamiento, prueba))
...
a6 <- 0
a7 <- 1
prueba2<- data.frame(a1,a2,a3,a4,a5,a6,a7)
#Normalizar para predecir


prediccion2 <- as.data.frame(predict(agrupamiento, prueba2))
colnames(prediccion2) <- c("Grupo")
```
